...
const float Chassis::INITIAL_ACCELERATION = 7.5;

const float Chassis::INITIAL_ACCELERATION_VARIANCE = 1.0;

const float Chassis::ACCELERATION_CHANGE_VARIANCE = 0.5;

const float Chassis::INITIAL_HANDLING = 11.0;

const float Chassis::INITIAL_HANDLING_VARIANCE = 1.0;

const float Chassis::HANDLING_CHANGE_VARIANCE = 1.0;

const float Chassis::MAX_ACCELERATION_VALUE = 10;

const  float Chassis::MAX_HANDLING_VALUE = 15;

const  float Chassis::MAX_SPEED_VALUE = 10;
